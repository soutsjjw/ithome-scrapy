...
def crawl_content(url):
    ...
    # print(article["responses"])
    insert_response(article["responses"])
...
def insert_response(responses):
    ...
    for response in responses:
        cursor.execute(
            """
DELETE FROM public.ithome_response WHERE article_id = %(article_id)s;
""",
            response,
        )
        ...
        cursor.execute(
            """
INSERT INTO public.ithome_response(article_id, author, publish_time, content)
